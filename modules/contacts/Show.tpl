        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2><?php echo _('Contacts'); ?>: <?php echo _('Contact Details'); ?></h2></td>
                </tr>
            </table>

            <p class="note"><?php echo _('Contact Details'); ?></p>
                ...
                <tr style="vertical-align:top;">
                    <td width="50%" height="100%">
                        <table class="detailsInside" height="100%">
                            ...
                            <tr>
                                <td class="vertical"><?php echo _('Company'); ?>:</td>
                                <td class="data">
                                    ...
                                    <?php if ($this->data['leftCompany']): ?>
                                        &nbsp;(<?php echo _('no longer associated with company'); ?>)
                                    <?php endif; ?>
                                </td>
                            </tr>

                            <tr>
                                <td class="vertical"><?php echo _('Title'); ?>:</td>
                                <td class="data"><?php $this->_($this->data['title']); ?></td>
                            </tr>

                            <tr>
                                <td class="vertical"><?php echo _('Department'); ?>:</td>
                            ...
                            <tr>
                                <td class="vertical"><?php echo _('Other Phone'); ?>:</td>
                    ...
                    <td width="50%" height="100%">
                        <table class="detailsInside" height="100%">
                            <tr>
                                <td class="vertical"><?php echo _('Reports To'); ?>:</td>
                                <td class="data">
                            ...
                            <tr>
                                ...
                                <?php if ($this->isShortNotes): ?>
                                    <td id="shortNotes" style="display:block;" class="data">
                                        ...
                                        <p><a href="#" class="moreText" onclick="toggleNotes(); return false;">[<?php echo _('More'); ?>]</a></p>
                                    </td>
                                    <td id="fullNotes" style="display:none;" class="data">
                                        <?php echo($this->data['notes']); ?>&nbsp;
                                        <p><a href="#" class="moreText" onclick="toggleNotes(); return false;">[<?php echo _('Less'); ?>]</a></p>
                                    </td>
                                <?php else: ?>
                                    <td id="shortNotes" style="display:block;" class="data">
                                        <?php echo($this->data['notes']); ?>
                            ...
                            <tr>
                                ...
                                <?php if ($this->getUserAccessLevel('contacts.addActivityScheduleEvent') >= ACCESS_LEVEL_EDIT): ?>
                                    <a href="#" onclick="showPopWin('<?php echo(CATSUtility::getIndexName()); ?>?m=contacts&amp;a=addActivityScheduleEvent&amp;contactID=<?php echo($this->contactID); ?>&amp;onlyScheduleEvent=true', 600, 200, null); return false;">
                                        <img src="images/calendar_add.gif" width="16" height="16" border="0" alt="Schedule Event" class="absmiddle" />&nbsp;<?php echo _('Schedule Event'); ?>
                                    </a>
                                <?php endif; ?>
                                </td>
                            </tr>
            ...
            <?php if ($this->getUserAccessLevel('contacts.edit') >= ACCESS_LEVEL_EDIT): ?>
                <a id="edit_link" href="<?php echo(CATSUtility::getIndexName()); ?>?m=contacts&amp;a=edit&amp;contactID=<?php echo($this->contactID); ?>">
                    <img src="images/actions/edit.gif" width="16" height="16" class="absmiddle" alt="edit" border="0" />&nbsp;<?php echo _('Edit'); ?>
                </a>
                &nbsp;&nbsp;&nbsp;&nbsp;
            <?php endif; ?>
            <?php if ($this->getUserAccessLevel('contacts.delete') >= ACCESS_LEVEL_DELETE): ?>
                <a id="delete_link" href="<?php echo(CATSUtility::getIndexName()); ?>?m=contacts&amp;a=delete&amp;contactID=<?php echo($this->contactID); ?>" onclick="javascript:return confirm('Delete this candidate?');">
                    <img src="images/actions/delete.gif" width="16" height="16" class="absmiddle" alt="delete" border="0" />&nbsp;<?php echo _('Delete'); ?>
                </a>
                &nbsp;&nbsp;&nbsp;&nbsp;
            <?php endif; ?>
            ...
            <p class="note"><?php echo _('Job Orders'); ?></p>
            <table class="sortable">
                <tr>
                    <th align="left" width="200"><?php echo _('Title'); ?></th>
                    <th align="left" width="15"><?php echo _('Type'); ?></th>
                    <th align="left" width="15"><?php echo _('Status'); ?></th>
                    <th align="left" width="60"><?php echo _('Created'); ?></th>
                    <th align="left" width="60"><?php echo _('Modified'); ?></th>
                    <th align="left" width="60"><?php echo _('Start'); ?></th>
                    <th align="right" width="15"><?php echo _('Age'); ?></th>
                    <th align="right" width="10"><?php echo _('S'); ?></th>
                    <th align="right" width="10"><?php echo _('P'); ?></th>
                    <th align="left" width="65"><?php echo _('Recruiter'); ?></th>
                    <th align="left" width="68"><?php echo _('Owner'); ?></th>
                </tr>
                        ...
                        <td align="center" >
                            <?php if ($this->getUserAccessLevel('contacts.editActivity') >= ACCESS_LEVEL_EDIT): ?>
                                <a href="#" id="editActivity<?php echo($activityData['activityID']); ?>" onclick="Activity_editEntry(<?php echo($activityData['activityID']); ?>, <?php echo($this->contactID); ?>, <?php echo(DATA_ITEM_CONTACT); ?>, '<?php echo($this->sessionCookie); ?>'); return false;">
                                    <img src="images/actions/edit.gif" width="16" height="16" alt="" class="absmiddle" border="0" title="<?php echo _('Edit'); ?>"/>
                                </a>
                            <?php endif; ?>
                            <?php if ($this->getUserAccessLevel('contacts.deleteActivity') >= ACCESS_LEVEL_EDIT): ?>
                                <a href="#" id="deleteActivity<?php echo($activityData['activityID']); ?>" onclick="Activity_deleteEntry(<?php echo($activityData['activityID']); ?>, '<?php echo($this->sessionCookie); ?>'); return false;">
                                    <img src="images/actions/delete.gif" width="16" height="16" alt="" class="absmiddle" border="0" title="<?php echo _('Delete'); ?>"/>
                                </a>
                            <?php endif; ?>
                        </td>
                    </tr>
            ...
            <div id="addActivityDiv">
                <?php if ($this->getUserAccessLevel('contacts.logActivityScheduleEvent') >= ACCESS_LEVEL_EDIT): ?>
                    <a href="#" id="addActivityLink" title="<?php echo _('Log an Activity'); ?> / <?php echo _('Schedule Event'); ?>" onclick="showPopWin('<?php echo(CATSUtility::getIndexName()); ?>?m=contacts&amp;a=addActivityScheduleEvent&amp;contactID=<?php echo($this->contactID); ?>', 600, 375, null); return false;">
                        <img src="images/new_activity_inline.gif" width="16" height="16" class="absmiddle" title="<?php echo _('Log an Activity'); ?> / <?php echo _('Schedule Event'); ?>" alt="<?php echo _('Log an Activity'); ?> / <?php echo _('Schedule Event'); ?>" border="0" />&nbsp;<?php echo _('Log an Activity'); ?> / <?php echo _('Schedule Event'); ?>
                    </a>
                <?php endif; ?>
