        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2><?php echo _('Companies'); ?>: <?php echo _('Add Company'); ?></h2></td>
                </tr>
            </table>
            ...
            <form name="addCompanyForm" id="addCompanyForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=companies&amp;a=add" method="post" onsubmit="return checkAddForm(document.addCompanyForm);" autocomplete="off">
                ...
                <table class="editTable" width="100%">
                    <tr>
                        ...
                        <td rowspan="5" align="left" valign="top">
                            <?php $freeformTop = '<p class="freeformtop">' . _('Cut and paste freeform address here.') . '</p>'; ?>
                            ...
                            <?php $freeformBottom = '<p class="freeformbottom">' . _('Cut and paste freeform address here.') . '</p>'; ?>
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <select tabindex="3" id="departmentsSelect" name="departmentsSelect" class="inputbox" style="width: 150px;" onchange="if (this.value == 'edit') { listEditor('Departments', 'departmentsSelect', 'departmentsCSV'); } this.value = 'num';">
                                ...
                                <option value="num" selected="selected"><?php echo _('No Departments'); ?></option>
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="isHotLabel" for="isHot"><?php echo _('Hot Company'); ?>:</label>
                        </td>
                        <td class="tdData">
                ...
                <p class="noteUnsized" style="margin-top: 5px;"><?php echo _('Other'); ?></p>
                ...
                <input type="submit" class="button" value="<?php echo _('Add Company'); ?>" />&nbsp;
                <input type="reset"  class="button" value="<?php echo _('Reset'); ?>" />&nbsp;
                <input type="button" class="button" value="<?php echo _('Back to Companies'); ?>" onclick="javascript:goToURL('<?php echo(CATSUtility::getIndexName()); ?>?m=companies&amp;a=show');" />
            </form>
