        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2><?php echo _('Companies'); ?>: <?php echo _('Edit Company'); ?></h2></td>
               </tr>
            </table>
            ...
            <form name="editCompanyForm" id="editCompanyForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=companies&amp;a=edit" method="post" onsubmit="return checkEditForm(document.editCompanyForm);" autocomplete="off">
                    ...
                    <tr>
                        <td valign="top" width="50%" height="285">
                            ...
                            <table class="editTable" width="100%" height="100%">
                                <tr>
                                    <td class="tdVertical">
                                        <label id="nameLabel" for="name"><?php echo _('Company Name'); ?>:</label>
                                    </td>
                                    <td class="tdData">
                                ...
                                <tr>
                                    <td class="tdVertical">
                                        <label id="billingContactLabel" for="billingContact"><?php echo _('Billing Contact'); ?>:</label>
                                    </td>
                                    <td class="tdData">
                                ...
                                <tr>
                                    <td class="tdVertical">
                                        <label id="departmentsLabel" for="departmentsSelect"><?php echo _('Departments'); ?>:</label>
                                    </td>
                                    <td class="tdData">
                                        <select tabindex="3" id="departmentsSelect" name="departmentsSelect" class="inputbox" style="width: 150px;" onchange="if (this.value == 'edit') { listEditor('Departments', 'departmentsSelect', 'departmentsCSV'); } this.value = 'num';">
                                            ...
                                            <option value="num" selected="selected"><?php printf(_('%s Departments'), count($this->departmentsRS)); ?></option>
                                ...
                                <tr>
                                    <td class="tdVertical">
                                        <label id="urlLabel" for="url"><?php echo _('Web Site'); ?>:</label>
                                    </td>
                                    <td class="tdData">
                                ...
                                <tr>
                                    ...
                                    <td class="tdData">
                                        ...
                                        <?php endif; ?>&nbsp;<?php echo _('Hot Company'); ?>
                                    </td>
                                </tr>
                        ...
                        <td width="50%" valign="top" height="285">
                            ...
                            <table class="editTable" width="100%" height="100%">
                                <tr>
                                    <td class="tdVertical">
                                        <label id="phone1Label" for="phone1"><?php echo _('Primary Phone'); ?>:</label>
                                    </td>
                                    <td class="tdData">
                                ...
                                <tr>
                                    <td class="tdVertical">
                                        <label id="phone2Label" for="phone2"><?php echo _('Secondary Phone'); ?>:</label>
                                    </td>
                                    <td class="tdData">
                                ...
                                <tr>
                                    <td class="tdVertical">
                                        <label id="faxNumberLabel" for="faxNumber"><?php echo _('Fax Number'); ?></label>
                                    </td>
                                    <td class="tdData">
                                ...
                                <tr id="changeAddress" style="display:none;">
                                    <td colspan="2" style="text-align:center;">
                                        <?php echo _('Edit all contacts address information to match company address?'); ?><br />
                                        <select id="updateContacts" name="updateContacts" class="inputbox">
                                            <option value="yes"><?php echo _('Yes, synchronize addresses.'); ?></option>
                                            <option value="no" selected="selected"><?php echo _('No, leave addresses unmodified.'); ?></option>
                                        </select>
                                    </td>
                                </tr>
                            </table>
                ...
                <p class="noteUnsized"><?php echo _('Other'); ?></p>
                ...
                <table class="editTable" width="100%">
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="keyTechnologiesLabel" for="keyTechnologies"><?php echo _('Key Technologies'); ?>:</label>
                        </td>
                        <td class="tdData">
                ...
                <input type="button" class="button" name="back"   id="back"   value="<?php echo _('Back to Details'); ?>" onclick="javascript:goToURL('<?php echo(CATSUtility::getIndexName()); ?>?m=companies&amp;a=show&amp;companyID=<?php echo($this->companyID); ?>');" />
            </form>
