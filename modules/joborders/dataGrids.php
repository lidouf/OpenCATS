...
class JobOrdersListByViewDataGrid extends JobOrdersDataGrid
{
    ...
    public function getInnerActionArea()
    {
        ...
        $html .= $this->getInnerActionAreaItemPopup(_('Add To List'), CATSUtility::getIndexName().'?m=lists&amp;a=addToListFromDatagridModal&amp;dataItemType='.DATA_ITEM_JOBORDER, 450, 350);
...
class joborderSavedListByViewDataGrid extends JobOrdersDataGrid
{
    ...
    public function getInnerActionArea()
    {
        ...
        $html .= $this->getInnerActionAreaItem(_('Remove From This List'), CATSUtility::getIndexName().'?m=lists&amp;a=removeFromListDatagrid&amp;dataItemType='.DATA_ITEM_JOBORDER.'&amp;savedListID='.$this->getMiscArgument(), false);
        $html .= $this->getInnerActionAreaItem(_('Export'), CATSUtility::getIndexName().'?m=export&amp;a=exportByDataGrid');
